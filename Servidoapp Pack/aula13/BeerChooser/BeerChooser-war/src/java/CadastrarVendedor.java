...
public class CadastrarVendedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        vendedor.setId(new Long(vendedorFacade.count()+1));
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CadastrarVendedor</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>Vendedor" +vendedor.getNome());
            out.println(", cadastrar com ID" + vendedor.getId() +"</h3>");
            out.println("<br>");
            out.println("<a href=\"cadastrarVendedor.jps\">Novo</a>");
            out.println("</body>");
            out.println("</html>");
